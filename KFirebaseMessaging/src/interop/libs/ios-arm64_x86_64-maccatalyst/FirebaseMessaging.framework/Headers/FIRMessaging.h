...
*
const FIRMessagingErrorDomain NS_SWIFT_NAME(MessagingErrorDomain);
/**
 ...
 */
- (void)subscribeToTopic:(NSString *)topic NS_SWIFT_NAME
 ...
 * @param topic The name of the topic, for example @"sports".
 */
- (void)unsubscribeFromTopic:(NSString *)topic NS_SWIFT_NAME
